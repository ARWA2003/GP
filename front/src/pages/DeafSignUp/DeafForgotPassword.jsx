  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-full min-h-screen bg-gray-100">
      ...
      <motion.div
        ...
        animate="animate"
        className="absolute w-[200px] h-[200px] bg-yellow-200 rounded-full top-[-50px] left-[-50px]"
      ></motion.div>

      <motion.div
        variants={circleAnimation}
        animate="animate"
        className="absolute w-[180px] h-[180px] bg-blue-500 rounded-full bottom-[10px] right-[-40px]"
      ></motion.div>
...
export default DeafForgotPassword;
