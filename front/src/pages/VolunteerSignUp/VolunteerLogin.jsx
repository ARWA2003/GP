      ...
      <div className="relative bg-gradient-to-r from-yellow-200 to-blue-500 p-8 rounded-lg shadow-lg z-10 w-full max-w-3xl grid place-items-center">
        <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md text-center">
          ...
          <div className="flex justify-between mt-4 text-sm">
            <button className="text-blue-500 hover:underline" onClick={() => navigate("/volunteer-forgot-password")}>
              Forgot Password?
            </button>
            <button className="text-blue-500 hover:underline" onClick={() => navigate("/volunteer-signup")}>
              Sign Up
            </button>
          </div>
        </div>
