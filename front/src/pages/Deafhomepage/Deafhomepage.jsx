...
const services = [
  ...
  { title: "Mental Health ChatBot", head: "Mental Health ChatBot", image: "../../../public/assets/chat1.jpg", link: "/chatbot", bg: "bg-yellow-100", description: "Offering mental health advice for deaf individuals", imgSize: "w-48 h-48" },
  ...
  { title: "Deaf Stories Books", image: "/assets/book123.png", link: "/books", bg: "bg-blue-100", description: "Enjoy entertainment services accessible for the deaf.", imgSize: "w-24 h-24 max-w-24 max-h-24 object-contain" },
