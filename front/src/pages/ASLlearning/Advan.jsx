...
export default function Advan() {
    ...
    return (
        ...
        <h1 className="text-xl font-bold text-center mb-6 text-[#0078AA] z-[1]">You are almost fluent! 🌟 This level will refine your signing skills, improve your speed and accuracy, and help you express yourself naturally in ASL. Master advanced conversations and become truly confident in sign language!</h1>
