...
export default function Beg() {
    ...
    return (
        ...
        <h1 className="text-xl font-bold text-center mb-6 text-[#0078AA] z-[1]">Welcome to the Beginner Level! This level will introduce you to ASL Level 1, where you will learn essential basic words and phrases through 27 engaging videos. Start your journey into sign language and build a strong foundation step by step 😊🤟</h1>
